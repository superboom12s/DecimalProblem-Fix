...
def String_add(Snum1, Snum2):
    ...
    try:
        ...
        raise TypeError("String numbers must not contain text and can only have one decimal separator.")
...
def String_sub(Snum1, Snum2):
    ...
    -------
    String
        The result of substracting one number to the other in a String-number.
...
def String_mul(Snum1, Snum2):
    """
    This function is used to multiply tro String-numbers.
    ...
    -------
    String
        The result of multiplying both String-numbers.
